...
const QueryState=({stateData,queryFetch,setData,status,isTask})=>{
    ...
    if (status === "loading") {
            ...
            return (
                ...
                <div className="loadingContainer" style={cssProps}>
        ...
        if (status === "error") {
            ...
            return (
                ...
                <div className="errorContainer" style={cssProps}>
                    <svg style={{marginRight:15}} version="1.0" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 512 512">
        ...
        if(isTask) /*return*/ return <TaskRoutes stateData={stateData} setData={setData}/>
        else /*return*/ return <MeetingRenderer stateData={stateData} setData={setData}/>
